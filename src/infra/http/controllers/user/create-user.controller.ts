...
const registerUserBodySchema = z.object({
  ...
  password: z
    .string()
    .min(6)
    .describe("The user's password (minimum 6 characters)"),
...
export class CreateUserController {
  ...
  @ApiOperation({
    ...
    description:
      'Registers a new user with their name, email, CPF, password, and roles.',
  })
  @ApiBody({
  ...
  @ApiResponse(successResponse('User created successfully.'))
